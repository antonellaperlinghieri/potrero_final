...
<head>
    ...
    <!--CHATCOMPOSER -->
    <link href="https://trial.chatcompose.com/static/land/main.c2b8f225.css" rel="stylesheet">    
<script async type="text/javascript" src="https://trial.chatcompose.com/static/trial/all/global/export/js/main.a7059cb5.js?user=trial_antonellaP&lang=ES" user="trial_antonellaP" landing="true" lang="ES"></script> 
        ...
        <div class="container text-center text-md-start mt-5">
            <div class="row mt-3">
                <div class="col-md-3 col-lg-2 col-xl-6 mx-auto mb-4">
                    ...
                    <h6 class="text-uppercase fw-bold mb-4" id = "contacto"><a class="btn btn-primary btn-lg btn-floating" style="background-color: #ac2bac;text-decoration:none;" href="#!" role="button"><i class="bi bi-instagram"></i></a> Seguinos en nuestras redes </h6>
                </div>
            </div>
        </div>
    </section>
