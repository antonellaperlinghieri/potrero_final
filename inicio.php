...
<header>
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="inicio.php"> <img src="assets/imagenes/logo2.png" class="logo .d-sm-none .d-md-block" alt="" srcset="" style="width: 25%; justify-content: center;" /> </a>
...
<div class="container">
    <div class="row">
        <div class="col-lg-6 col-xl-6 mx-auto mb-4" style="margin-left: auto;">
            ...
            <p class="text">
                DESDE 1960, SE HA CONVERTIDO EN UN REFERENTE INDISCUTIDO A LA HORA DE BUSCAR DISEÑOS, CALIDAD Y CONFORT. DURANTE MÁS DE 60 AÑOS NOS HEMOS DEDICADO EXCLUSIVAMENTE A FABRICAR Y DISTRIBUIR PRODUCTOS CON LA ÚLTIMA TECNOLOGÍA,
                QUE BRINDEN EL MÁXIMO CONFORT EN MOVIMIENTO. CONTAMOS CON UNA TIENDA DE MÁS DE 3300 M², UN ESPACIO CON LA MÁS AMPLIA VARIEDAD DE PRODUCTOS CREADOS PARA EL CONFORT. LA ELECCIÓN PERSONALIZADA DE LA TAPICERÍA HACE DE CADA
                PRODUCTO UNA PIEZA ÚNICA.
            </p>
        </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="card">
                                            <img
                                                class="img-fluid"
                                                alt="100%x280"
                                                src=" https://mijormi.vteximg.com.br/arquivos/ids/177116-1000-1332/Silla-de-comedor-pana-gris-pata-cromada-MALAIKA-DARK-GREY-Landmark-01.jpg?v=637963453149300000"
                                            />
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
